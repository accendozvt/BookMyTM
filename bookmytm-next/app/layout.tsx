...
export const metadata: Metadata = {
  ...
  title: 'BookMyTM – Trademark Registration & ISO Certification',
  description:
    "India's trusted platform for trademark registration, ISO certification, startup registration, and IP services.",
  openGraph: {
    siteName: 'BookMyTM',
    type: 'website',
    images: [{ url: '/assets/opengraph/preview.webp', width: 1200, height: 630, alt: 'BookMyTM – Click. Start Business!' }],
  },
  twitter: {
    ...
    <html lang="en" className={manrope.variable}>
      <body>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          aria-label="Chat with BookMyTM on WhatsApp"
          className="fixed bottom-6 right-6 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] shadow-[0_12px_30px_rgba(37,211,102,0.45)] transition hover:scale-110"
        >
