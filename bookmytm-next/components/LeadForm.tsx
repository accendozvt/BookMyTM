      ...
      {sent ? (
        ...
        <form onSubmit={submitWhatsApp} className="space-y-3.5 px-7 py-6">
          ...
          <button
            type="submit"
            disabled={!valid}
            className="flex w-full items-center justify-center gap-2 rounded-full bg-brand py-3.5 text-[15px] font-bold text-white shadow-lg shadow-brand/25 transition hover:-translate-y-0.5 hover:bg-[#2f5622] disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none disabled:hover:translate-y-0"
          >
