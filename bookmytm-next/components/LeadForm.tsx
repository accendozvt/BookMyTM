...
export default function LeadForm({
  ...
  return (
    <div className="overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-gray-200/70">
      {/* Price header */}
      <div className="hero-bg px-6 py-5 text-white">
      ...
      {sent ? (
        ...
        <form onSubmit={submitWhatsApp} className="space-y-3 px-6 py-5">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2 text-[15px] outline-none transition focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/20"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-2 text-[15px] outline-none transition focus:border-brand focus:bg-white focus:ring-2 focus:ring-brand/20"
            />
          </div>
          <button
            type="submit"
            disabled={!valid}
            className="flex w-full items-center justify-center gap-2 rounded-full bg-brand py-3 text-[15px] font-bold text-white shadow-lg shadow-brand/25 transition hover:-translate-y-0.5 hover:bg-[#2f5622] disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none disabled:hover:translate-y-0"
          >
